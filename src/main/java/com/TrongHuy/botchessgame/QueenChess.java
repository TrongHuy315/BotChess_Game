...
public class QueenChess extends Chess {
    ...
    public QueenChess(boolean color, int x, int y) {
        super(color, x, y);

        String imagePath = color != false ? getClass().getResource("/images/bq.png").toString() : getClass().getResource("/images/wq.png").toString();
