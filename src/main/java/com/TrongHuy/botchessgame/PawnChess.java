...
public class PawnChess extends Chess {
    ...
    public PawnChess(boolean color, int x, int y) {
        super(color, x, y);

        String imagePath = color != false ? getClass().getResource("/images/bp.png").toString() : getClass().getResource("/images/wp.png").toString();
