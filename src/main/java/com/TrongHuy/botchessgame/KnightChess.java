...
public class KnightChess extends Chess {
    ...
    public KnightChess(boolean color, int x, int y) {
        super(color, x, y);

        String imagePath = color != false ? getClass().getResource("/images/bn.png").toString() : getClass().getResource("/images/wn.png").toString();
