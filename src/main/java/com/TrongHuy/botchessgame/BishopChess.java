...
public class BishopChess extends Chess {
    ...
    public BishopChess(boolean color, int x, int y) {
        super(color, x, y);

        String imagePath = color != false ? getClass().getResource("/images/bb.png").toString() : getClass().getResource("/images/wb.png").toString();
